...
class Trainer(object):
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            # writer.add_scalar('Training loss', (train_loss / (i+1), epoch), epoch*(self.len_train_loader)+i)
    ...
    def validation(self, epoch):
        ...
        self.writer.add_scalar('val/fxwIoU', FWIoU, epoch)
        ...
        print('Validation:')
        print('[Epoch: %d, numImages: %5d]' % (epoch, i * self.args.batch_size + image.data.shape[0]))
        print("Acc:{}, Acc_class:{}, mIoU:{}, fwIoU: {}, Precision:{}, Recall:{}, F1_Score: {}".format(Acc, Acc_class, mIoU, FWIoU, precision, recall, f1_score))
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='PV',
                        choices=['pascal', 'coco', 'cityscapes', 'PV'],
                        help='dataset name (default: PV)')
    ...
    parser.add_argument('--gpu-ids', type=str, default='2',
                        ...
                        comma-separated list of integers only (default=1)')
