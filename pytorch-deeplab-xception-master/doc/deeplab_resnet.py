...
class ResNet(nn.Module):
    ...
    def __init__(self, nInputChannels, block, layers, os=16, pretrained=True):
        self.inplanes = 64
...
class DeepLabv3_plus(nn.Module):
    def __init__(self, nInputChannels=3, n_classes=21, os=16, pretrained=True, freeze_bn=False, _print=True):
        if _print:
        ...
        # Atrous Conv
        self.resnet_features = ResNet101(nInputChannels, os, pretrained=True)
